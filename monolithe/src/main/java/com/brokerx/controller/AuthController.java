...
import com.brokerx.service.AuditService; // ✅ AJOUT
import org.slf4j.Logger;
import org.slf4j.LoggerFactory;
import org.springframework.http.ResponseEntity;
import org.springframework.security.crypto.password.PasswordEncoder;
import org.springframework.web.bind.annotation.*;
import jakarta.servlet.http.HttpServletRequest; // ✅ AJOUT
...
public class AuthController {
    ...
    public AuthController(UserService userService, AccountService accountService, 
                         ...
                         JwtConfig jwtConfig, AuditService auditService) { // ✅ AJOUT
    ...
    public ResponseEntity<Map<String, Object>> register(
            ...
            HttpServletRequest httpRequest) { // ✅ AJOUT pour récupérer l'IP
        ...
        try {
            ...
            auditService.logAction(
                ...
                savedUser.getUserId(), 
                "CREATE", 
                null, // Pas encore d'utilisateur connecté
    ...
    public ResponseEntity<LoginResponse> login(
        ...
        try {
            ...
            // ✅ AUDIT : Log tentative de connexion (avant MFA)
