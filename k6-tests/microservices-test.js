// ============================================
// K6 Load Test - Microservices Architecture
// ============================================
// Test de charge pour l'architecture microservices avec API Gateway
...
function generateOrderData() {
  ...
  const quantity = Math.floor(Math.random() * 5) + 1; // 1-5 actions
...
export default function () {
  ...
  // ========================================
  // Dépôt plus important pour couvrir les ordres (5000-10000 USD)
  const depositAmount = (Math.random() * 5000 + 5000).toFixed(2);
...
export function setup() {
  console.log('========================================');
  console.log('K6 Load Test - Microservices Architecture');
  console.log('========================================');
